"""Apply the v0.1.282 additive PostgreSQL upgrade: expense settlement/invoice mapping table.
...
Usage (deploy host):
    python3 scripts/upgrade_postgresql_0282.py --database invoice_tool_production
"""
import argparse
import subprocess
import sys
...
MIGRATION = ROOT / "migrations" / "postgresql" / "0282-expense-settlement-invoice-map.sql"
CONTAINER = "invoice-tool-postgres"
ROLE = "invoice_owner"
EXPECTED_VERSION = "0252-compat-v2"
TABLE = "expense_settlement_invoice_map"
