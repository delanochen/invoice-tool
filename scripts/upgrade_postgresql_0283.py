...
Usage (deploy host):
    python3 scripts/upgrade_postgresql_0283.py --database invoice_tool_production
"""
import argparse
import subprocess
import sys
...
MIGRATION = ROOT / "migrations" / "postgresql" / "0283-expense-ai-reviews.sql"
CONTAINER = "invoice-tool-postgres"
ROLE = "invoice_owner"
EXPECTED_VERSION = "0252-compat-v2"
TABLE = "expense_ai_reviews"
